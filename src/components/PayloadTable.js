      ...
      <CardExtraLarge className="overflow-x-auto">
        <div className="md:flex items-center mb-4">
          ...
          <Link
            ...
            className="px-4 py-1 text-sm whitespace-no-wrap font-semibold bg-yellow-600 text-white hover:bg-yellow-700 rounded-sm shadow-sm md:ml-4">
            Tambah Perhitungan
          </Link>
          <a
            href={`${
              process.env.REACT_APP_SERVER_LINK
            }/payloads/print?${url.queryString(queryFilter)}`}
            target="_blank"
